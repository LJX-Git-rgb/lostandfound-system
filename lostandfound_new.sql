...
CREATE TABLE `admin_user` (
  ...
  `uid` varchar(255) NOT NULL COMMENT 'uid，不可重复',
...
CREATE TABLE `feedback` (
  ...
  `lid` int DEFAULT NULL COMMENT '寻物启事id',
  `fid` int DEFAULT NULL COMMENT '失物招领id',
...
CREATE TABLE `found_goods` (
  ...
  `tag` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标签,&进行分割',
...
CREATE TABLE `user_base` (
  ...
  `user_role` tinyint unsigned DEFAULT NULL COMMENT '1正常用户 2身份认证用户 3学生认证用户 4禁言用户 5注销用户 6管理员',
